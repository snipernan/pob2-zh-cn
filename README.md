...
当前独立插件 **v0.6.4**，已验证核心 **0.23.1**、天赋树 **0.5**。由社区维护，围绕原生 Mac 版 PoB2 的使用体验持续完善。
...
当前验证平台为 Apple Silicon Mac，字库覆盖已收录译文及 GB2312 的 6763 个常用汉字。装备导入沿用 PoB 的英文文本格式，并兼容编年史 WeGame 转换结果中的带显式加号抗性词缀（如 `Fire Resistance is +22%`）；技能长说明、历史版本及动态效果按已核验的映射显示，其余文字保留英文。
